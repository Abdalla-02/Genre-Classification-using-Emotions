...
single ten-second clip while each test row aggregates the cues of an entire film. What
...
object as an Eerola clip, whereas a film-level mean over some 39 cues is not. Applying
...
on the unit comparable to an Eerola clip, are of the same order as the originals
